...
Example rmarkdown notebook [example.Rmd](example.Rmd) shows how to use
functions available in `read_od_data.R` script. To try it out with the example data, clone this repository and then
1. Open rstudio
